...
int main()
{
	    ...
	    /*
			...
			* 	#define XSPIPS_CLK_ACTIVE_LOW_OPTION		0x00000002U  /**< Active Low Clock option
	    	 ...
	    	 *
	    	 */
	    	 XSpiPs_SetOptions(SpiInstancePtr, XSPIPS_MASTER_OPTION | XSPIPS_CLK_PHASE_1_OPTION | XSPIPS_FORCE_SSELECT_OPTION);
	...
	//    	WriteData[23]	=0b11111111;
	    	...
	    	for(int i=0; i<24; i++){
	    		...
	    		XSpiPs_Transfer(&SpiInstancePtr, &WriteData[i], NULL,1);
