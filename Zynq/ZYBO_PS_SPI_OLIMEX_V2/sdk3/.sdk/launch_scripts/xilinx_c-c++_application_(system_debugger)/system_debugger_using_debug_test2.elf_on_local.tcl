...
targets -set -filter {jtag_cable_name =~ "Digilent Zybo 210279572323A" && level==0} -index 1
fpga -file D:/FPGA/Olimex_RGB_Matrix/matrix_vc/sdk3/design_1_wrapper_hw_platform_0/design_1_wrapper.bit
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Digilent Zybo 210279572323A"} -index 0
...
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo 210279572323A"} -index 0
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo 210279572323A"} -index 0
dow D:/FPGA/Olimex_RGB_Matrix/matrix_vc/sdk3/test2/Debug/test2.elf
