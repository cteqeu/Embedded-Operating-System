...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net HC_SR04_0_centimeter [get_bd_pins HC_SR04_0/centimeter] [get_bd_pins vio_0/probe_in0]
  connect_bd_net -net HC_SR04_0_sonar_trig [get_bd_ports sonar_trig_0] [get_bd_pins HC_SR04_0/sonar_trig]
  connect_bd_net -net clk_wiz_0_clk100MHz [get_bd_pins HC_SR04_0/clk] [get_bd_pins clk_wiz_0/clk100MHz] [get_bd_pins vio_0/clk]
  connect_bd_net -net sonar_echo_0_1 [get_bd_ports sonar_echo_0] [get_bd_pins HC_SR04_0/sonar_echo]
